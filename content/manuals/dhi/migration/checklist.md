...
| Multi-stage build  | Use `dev` or `sdk`-tagged images for build stages where you need build tools and package managers. Use runtime images for your final runtime stage.                                                                                                                                                                                                                                     |
