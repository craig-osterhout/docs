---
description: Learn how to deploy pre-trained models in web applications to perform face detection.
keywords: tensorflow.js, machine learning, ml, mediapipe
title: TensorFlow.js with Docker
toc_max: 2
---

This guide introduces the seamless integration of TensorFlow.js with Docker. In
this guide, you'll explore:

- How to run a containerized TensorFlow.js application with Docker
- The application code for a face detection application using TensorFlow.js
